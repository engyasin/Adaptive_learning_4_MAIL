...
class MultiGridEnv(gym.Env):
    ...
    def seed(self, seed=1337):
        ...
        try:
            self.randint = self.np_random.randint
        except AttributeError:
            self.randint = self.np_random.integers
        return [seed]
    ...
    def _rand_pos(self, xLow, xHigh, yLow, yHigh):
        ...
        return (
            self.randint(xLow, xHigh),
            self.randint(yLow, yHigh)
        )
            ...
            # Move forward
                ...
                if fwd_cell is not None:
                    ...
                    if fwd_cell.type == 'goal':
                        # it's never goal but objectgoal in soccer
                        done = True
                    ...
                    #self._handle_attack( i, rewards, fwd_pos, fwd_cell)
